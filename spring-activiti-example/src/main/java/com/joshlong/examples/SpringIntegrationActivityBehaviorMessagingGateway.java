 ...
 * <p/>
 * We need to build an {@link org.activiti.pvm.ActivityBehavior} that can send and receive the message, propagating the {@code executionId}
 * and potentially process variables/ header variables.
 *
 ...
 */
public class SpringIntegrationActivityBehaviorMessagingGateway extends AbstractMessagingGateway implements ActivityBehavior, InitializingBean {
